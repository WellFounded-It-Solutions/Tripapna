...
<div class="content-wrapper">
    <div class="container-fluid">
        <div class="text-black p-2">
            <h4 class="mb-0">Add New Holiday Package</h4>
        </div>
        <div class="card-body">
            <form class="form-horizontal ajax_form" action="{{ route(Auth::user()->roles[0]->params.'_holiday_package_store') }}" method="post" id="user">
                {{ csrf_field() }}

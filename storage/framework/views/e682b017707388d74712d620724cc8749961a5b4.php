         ...
         <div class="row">
            <div class="col-12">
               <div class="clearfix mb-5">
                	<?php if(auth()->check() && auth()->user()->can('add-categories')): ?>
    ...
    <div class="modal-dialog modal-lg" role="document ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal ajax_form" action="<?php echo e(route(Auth::user()->roles['0']->params.'_categories_store')); ?>" method="post" id="user">
...
<div class="modal-dialog modal-lg" role="document ">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal ajax_form" action="<?php echo e(route(Auth::user()->roles['0']->params.'_categories_update')); ?>" method="post">
                <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\client\tripapna\admin\resources\views/Category/index.blade.php ENDPATH**/ ?>
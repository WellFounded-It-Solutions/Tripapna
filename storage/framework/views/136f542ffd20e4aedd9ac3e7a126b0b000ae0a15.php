        ...
        <div class="popular-store-list">
            <div class="row" *ngIf="hotellist?.length">
                ...
                <div class="col-lg-3 col-sm-4 col-6 col-md-4" *ngFor="let Item of hotellist;">
                    <div class="item">
                        <a href="/stores-details/<?php echo e($hotel->id); ?>">
...
<?php echo $__env->make('user.layouts.app_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\client\tripapna\admin\resources\views/user/all-stores.blade.php ENDPATH**/ ?>
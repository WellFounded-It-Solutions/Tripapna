    ...
    <div class="popular-store-inner">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="popular-store-content" style="background-image: url('<?php echo e(asset('img/TripApna/hotel.jpg')); ?>')">
                    <div class="content">
                        <h2>Popular Hotel</h2>
                ...
                <div class="popular-store-list">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-4 col-6 col-md-4">
                            <div class="item">
                                <a routerLink="stores-details/<?php echo e($hotel->id); ?>">
                                    <img src="<?php echo e($hotel->logo); ?>" alt="image">
                                </a>
                                <span class="location"><i class='bx bxs-map'></i><?php echo e($hotel->location); ?></span>
                            </div>
                        </div>
...
<?php /**PATH E:\client\tripapna\admin\resources\views/user/comp/popular-store.blade.php ENDPATH**/ ?>
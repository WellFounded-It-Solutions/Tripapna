            ...
            <div class="row">
                <div class="col-12">
                    <div class="clearfix mb-5">
                        <?php if(auth()->check() && auth()->user()->can('add-single-package')): ?>
...
<div class="modal fade " id="addFromPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true ">
    <div class="modal-dialog modal-lg" role="document ">
        <form class="form-horizontal ajax_form" action="<?php echo e(route(Auth::user()->roles['0']->params.'_single_package_store')); ?>" method="post" id="user">
...
<div class="modal fade " id="editFromPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true ">
    <div class="modal-dialog modal-lg" role="document ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal ajax_form" action="<?php echo e(route(Auth::user()->roles['0']->params.'_single_package_update')); ?>" method="post">
                    <?php echo e(csrf_field()); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <option value=""></option>
                                    <?php $__currentLoopData = $couponRecord; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                        <option value="<?php echo e($val->id); ?>"><?php echo e(ucfirst($val->title)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
                                </select>
                            </div>
...
<div class="modal fade " id="cloneFromPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true ">
    <div class="modal-dialog modal-lg" role="document ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal ajax_form" action="<?php echo e(route(Auth::user()->roles['0']->params.'_single_package_clone')); ?>" method="post">
                    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\client\tripapna\admin\resources\views/singlepackage/index.blade.php ENDPATH**/ ?>
         ...
         <div class="row">
            <div class="col-12">
               <div class="clearfix mb-5">
                	<?php if(auth()->check() && auth()->user()->can('create-hotel')): ?>
...
<div class="modal fade " id="addFromPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true ">
    <div class="modal-dialog modal-lg" role="document ">
        <form class="form-horizontal ajax_form" action="<?php echo e(route(Auth::user()->roles['0']->params.'_hotel_store')); ?>" method="post" id="user">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="hotel_category" >
                                    ...
                                    <?php $__currentLoopData = $hotel_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="modal-dialog modal-lg" role="document ">
    <form class="form-horizontal ajax_form" action="<?php echo e(route(Auth::user()->roles['0']->params.'_hotel_update')); ?>" method="post">
    <div class="modal-content">
        <div class="modal-header">
...
<?php echo $__env->make('layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\client\tripapna\admin\resources\views/hotels/index.blade.php ENDPATH**/ ?>
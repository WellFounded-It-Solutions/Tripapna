...
<div class="page-title-area" style="background-image: url(<?php echo e($productdata->image); ?>);">
    <div class="container">
        <h1><?php echo e($productdata->title); ?></h1>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                    ...
                    <owl-carousel-o [options]="dealsDetailsImageSlides">
                        <ng-template carouselSlide>
                            <div class="article-image">
                                <img src="<?php echo e($productdata->image); ?>" alt="image">
                            </div>
                        </ng-template>
                        <div class="single-slider owl-carousel owl-theme">
                            <?php $__currentLoopData = $productdata->hotel->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imgs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="article-image">
                                <img src="<?php echo e(asset($imgs->images)); ?>" alt="image">
                            </div>
                ...
                <div class="deals-details-content">
                    <h3><?php echo e($productdata->title); ?></h3>
                    <div class="rating d-flex align-items-center">
                        ...
                        <span class="bx bxs-star checked"></span>
                        <span class="bx bxs-star checked"></span>
                        <span class="rating-count">(<?php echo e($productdata->rating || 0); ?>)</span>
                    </div>
                    <ul class="d-flex align-items-center">
                        <li class="phone-number">
                            <a href="tel:+2122791456"><i class="bx bx-phone-call"></i>
                                <?php echo e($productdata->hotel->mobile); ?></a>
                        </li>
                        <li class="location">
                            <i class="bx bx-map"></i>
                            <span>Location</span>
                            <?php echo e($productdata->hotel->location); ?>

                        </li>
                        <a href="https://google.com/maps?q=<?php echo e($productdata->hotel->lat); ?>,<?php echo e($productdata->hotel->long); ?>" target="_blank"> <i class="fa fa-map"></i></a>
                ...
                <div class="deals-details-desc">
                    ...
                    <div class="cart-table table-responsive">
                        <h3>Package Includes (<?php echo e(isset($productdata->PackageItem) ? count($productdata->PackageItem) : 0); ?>)</h3>
                        <table class="table table-bordered">
                            <!-- <th>Image</th> -->
                            <!-- <th>Title</th>
                            <th>Description</th> -->
                            <?php $__currentLoopData = $productdata->PackageItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td> <img src="<?php echo e(asset($item->coupondata->image)); ?>" alt="image"></td>
                                <td>
                                    <div>
                                        <h6><?php echo e($item->coupondata->title); ?></h6>
                                        <p >
                                            <?php echo e($item->coupondata->description); ?>
                    ...
                    <div class="terms-section">
                        ...
                        <p>
                            <?php echo e($productdata->term_conditions); ?>
            ...
            <div class="col-lg-4 col-md-12">
                <aside class="widget-area">
                    <div class="widget widget_deals_sidebar">
                        <div class="price">
                            <span class="new-price"><i class="fa fa-rupee"></i><?php echo e($productdata->amount); ?></span>
...
<?php echo $__env->make('user.layouts.app_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\client\tripapna\admin\resources\views/user/deal-details.blade.php ENDPATH**/ ?>
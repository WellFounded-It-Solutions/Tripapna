...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <form class="form-horizontal ajax_form" action="<?php echo e(route('hoteladmin_coupons_store')); ?>" method="post" id="user">
...
<form class="form-horizontal ajax_form" action="<?php echo e(route('hoteladmin_coupons_update')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\client\tripapna\admin\resources\views/hotelpanel/Coupon/index.blade.php ENDPATH**/ ?>